-- Fix ground agent movement: use shortest-path longitude so agents move toward
-- target instead of the long way around (e.g. -170 to 170 should go 20 deg, not 340).
...
BEGIN
  ...
  LOOP
    ...
    -- Satellite: advance along route (unchanged)
